...
struct qt_meta_stringdata_RenderWindowUISingleInheritance_t {
    QByteArrayData data[5];
    char stringdata0[62];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RenderWindowUISingleInheritance_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RenderWindowUISingleInheritance_t qt_meta_stringdata_RenderWindowUISingleInheritance = {
    {
QT_MOC_LITERAL(0, 0, 31), // "RenderWindowUISingleInheritance"
QT_MOC_LITERAL(1, 32, 8), // "slotExit"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 8), // "slotOpen"
QT_MOC_LITERAL(4, 51, 10) // "slotUpdate"

    },
    "RenderWindowUISingleInheritance\0"
    "slotExit\0\0slotOpen\0slotUpdate"
};
...
const QMetaObject RenderWindowUISingleInheritance::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_RenderWindowUISingleInheritance.data,
      qt_meta_data_RenderWindowUISingleInheritance,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RenderWindowUISingleInheritance::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RenderWindowUISingleInheritance.stringdata0))
